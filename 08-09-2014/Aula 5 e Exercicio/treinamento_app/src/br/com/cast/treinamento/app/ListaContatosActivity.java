...
public class ListaContatosActivity extends LifeCicleActivity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		// Opção 1:
		menu.setGroupVisible(R.id.grupo_selecao, contatoSelecionado != null);
	...
	public void executarAcaoMenu(int id) {
		switch (id) {
		case R.id.action_novo:
			Intent intentNovo = new Intent(this, ContatoActivity.class);
			super.startActivity(intentNovo);
			break;
