...
public class ListaContatosActivity extends LifeCicleActivity {
	...
	public static final String CHAVE_PARAMS = "CHAVE_PARAMS";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (params != null) {
			filtroNome = params.getString("nome");
			filtroTelefone = params.getString("telefone");
			filtraListView(filtroNome, filtroTelefone);
		}else{
			carregarListView();
		}
	...
	private void filtraListView(String filtroNome, String filtroTelefone) {
		List<Contato> contatos = ContatoService.getInstancia(this).pesquisarContatos(filtroNome, filtroTelefone);
		ContatoAdapter adapter = new ContatoAdapter(this, contatos);
		listViewContatos.setAdapter(adapter);
