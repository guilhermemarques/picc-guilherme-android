...
public final class ContatoService {
	...
	public List<Contato> pesquisarContatos(String filtroNome, String filtroTelefone){
		return ContatoDAO.getInstancia(contexto).pesquisarContatos(filtroNome, filtroTelefone);
	}
